...
class TextGen:
    def __init__(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("google/gemma-2b-it", token=auth_token)
        self.model = AutoModelForCausalLM.from_pretrained("google/gemma-2b-it", torch_dtype=torch.bfloat16, token=auth_token)
